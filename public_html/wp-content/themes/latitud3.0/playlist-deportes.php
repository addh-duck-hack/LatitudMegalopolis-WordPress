         ...
         <div class="row pleca">
            <div class="col-12 col-md-8 principal">
               <div id="videoPrincipal">
                 <?php query_posts('category_name=VideosDeportes')?><!--Para elegir categoria en slider-->
            ...
            <div class="col-12 col-md-4 secundario">
               <div class="contSecundario">
                 <?php query_posts('category_name=VideosDeportes&posts_per_page=999')?><!--Para elegir categoria en slider-->
                   <?php $i = 1; if ( have_posts() ) : while ( have_posts() && $i < 9) : the_post(); ?>
                   <!--Codigo que se ejecutara cuando encuentre algun post-->
                      <div class="row rowDeportes align-items-center" id="video-<?php echo get_the_ID(); ?>">
                         <div class="col-6">
